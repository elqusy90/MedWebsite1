...
class CreateDrugAlergicInteractionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drug_alergic_interactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('drug_alergic_interactions');
    }
}
